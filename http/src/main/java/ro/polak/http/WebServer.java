...
public final class WebServer extends Thread {
    ...
    public void run() {
        ...
        //LOGGER.log(Level.INFO, "WebServer.run is running." + " thread ID = " + Thread.currentThread().getId());
    ...
    public boolean startServer() {
        ...
        LOGGER.log(Level.INFO, "Server has been started. Listening on port " + serverSocket.getLocalPort());
