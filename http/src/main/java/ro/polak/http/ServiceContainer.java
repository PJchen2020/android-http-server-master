...
public final class ServiceContainer {
    ...
    public ServiceContainer(final ServerConfig serverConfig) {
        ...
        //LOGGER.log(Level.INFO, "ServiceContainer constructor is running, max thread is " + serverConfig.getMaxServerThreads());
        //threadPoolExecutor = new ThreadPoolExecutor(1, serverConfig.getMaxServerThreads(),
        threadPoolExecutor = new ThreadPoolExecutor(serverConfig.getMaxServerThreads() / 2, serverConfig.getMaxServerThreads(),  //derek
