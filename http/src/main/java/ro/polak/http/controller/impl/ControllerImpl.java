...
public class ControllerImpl implements Controller {
    ...
    private final ServerGui gui;  //main service context
    ...
    public void start() throws IllegalStateException {
        ...
        webServer = new WebServer(serverSocket, serverConfigFactory.getServerConfig(gui));
        //LOGGER.log(Level.INFO, "ControllerImpl.start is running." + " thread ID = " + Thread.currentThread().getId());
