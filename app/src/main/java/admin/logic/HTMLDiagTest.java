 ...
 */
public final class HTMLDiagTest {
    ...
    public HTMLDiagTest(final String title) {
        this.title = title;
    ...
    public HTMLDiagTest(final String title, final boolean isAuthenticated) {
        this(title);
    ...
    public String toString() {
        ...
        out.append("<title>").append(title).append(" TC Diagnostic Test </title>\n");
        ...
        out.append("<script type=\"text/javascript\" src=\"/assets/js/btnclick.js\" ></script>\n");
        out.append("</body>\n");
        out.append("</html>\n");
