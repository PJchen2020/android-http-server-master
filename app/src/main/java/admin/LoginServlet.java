...
public class LoginServlet extends HttpServlet {
    ...
    public void service(final HttpServletRequest request, final HttpServletResponse response) throws ServletException {
        ...
        doc.writeln("<p> getServiceContext --> " +  serverConfig.getServiceContext() + "</p>"); //ro.polak.http.configuration.ServerConfig
        //doc.writeln("<p> 123" +  request.getClass().getName() + "</p>"); ==> 123ro.polak.http.servlet.impl.HttpServletRequestImpl
