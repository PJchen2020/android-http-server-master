...
import admin.BTTestServlet;
import admin.DemoServlet;
import admin.DriveAccessServlet;
import admin.EmptyServlet;
    ...
    protected DeploymentDescriptorBuilder getDeploymentDescriptorBuilder(final SessionStorage sessionStorage,
        ...
        return super.getDeploymentDescriptorBuilder(sessionStorage, serverConfig)
                .addServletContext()
                    ...
                    .end()
                    .addServlet()
                        .withUrlPattern(Pattern.compile("^/bluetooth"))
                        .withServletClass(BluetoothServlet.class)
                    .end()
                    .addServlet()
                ...
                .addServletContext()
                    ...
                    .addServlet()
                        .withUrlPattern(Pattern.compile("^/BTTest$"))
                        .withServletClass(BTTestServlet.class)
                    .end()
                    ...
                    .addServlet()
                    .withUrlPattern(Pattern.compile("^/demo$"))
                    .withServletClass(DemoServlet.class)
                    .end()
